...
export class staking_token_contract extends ethereum.SmartContract {
  static bind(address: Address): staking_token_contract {
    return new staking_token_contract("staking_token_contract", address);
  }
